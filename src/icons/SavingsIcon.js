...
class SavingsIcon extends React.Component{
 ...
 render() {
   return (
    <svg className="brief-case" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 32 32" aria-labelledby="title">
